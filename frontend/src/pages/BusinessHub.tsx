...
import { ShieldCheck, MessageSquare, FileText, Stethoscope, Target, Play, Sparkles, AlertCircle, CheckCircle } from 'lucide-react';
    ...
    <div style={{ padding: '32px', color: 'white', maxWidth: '1400px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
          <div style={{ background: 'linear-gradient(135deg, #6366f1 0%, #a855f7 100%)', borderRadius: '8px', padding: '8px', display: 'flex' }}>
            <Sparkles size={24} color="white" />
          </div>
          <h1 style={{ margin: 0, fontSize: '1.875rem', fontWeight: 700 }}>Enterprise Business Engines Hub</h1>
        </div>
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              backgroundColor: activeTab === tab.id ? 'var(--brand)' : 'rgba(255,255,255,0.05)',
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px' }}>
        ...
        <div style={{ backgroundColor: 'var(--bg-card)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.08)', padding: '24px' }}>
          {activeTab === 'compliance' && (
            <div>
              <h3 style={{ marginTop: 0, fontSize: '1.2rem' }}>🏢 AI Compliance & Policy Auditor</h3>
              <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}>Scan company policies or contracts for GDPR/HIPAA violations.</p>
              <div style={{ marginBottom: '16px' }}>
                <label style={{ display: 'block', fontSize: '0.85rem', color: '#94a3b8', marginBottom: '6px' }}>Target Regulation</label>
                <input value={targetReg} onChange={(e) => setTargetReg(e.target.value)} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.1)', backgroundColor: 'var(--bg-base)', color: 'white' }} />
              </div>
              <div style={{ marginBottom: '20px' }}>
                <label style={{ display: 'block', fontSize: '0.85rem', color: '#94a3b8', marginBottom: '6px' }}>Policy / Contract Document</label>
                <textarea rows={6} value={complianceDoc} onChange={(e) => setComplianceDoc(e.target.value)} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.1)', backgroundColor: 'var(--bg-base)', color: 'white', resize: 'vertical' }} />
              </div>
          ...
          {activeTab === 'voc' && (
            <div>
              <h3 style={{ marginTop: 0, fontSize: '1.2rem' }}>📞 Voice of Customer (VoC) Engine</h3>
              <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}>Turn thousands of customer feedback entries into roadmap priorities.</p>
              <div style={{ marginBottom: '20px' }}>
                <label style={{ display: 'block', fontSize: '0.85rem', color: '#94a3b8', marginBottom: '6px' }}>Customer Feedback Entries (one per line)</label>
                <textarea rows={8} value={vocFeedback} onChange={(e) => setVocFeedback(e.target.value)} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.1)', backgroundColor: 'var(--bg-base)', color: 'white', resize: 'vertical' }} />
              </div>
          ...
          {activeTab === 'proposal' && (
            <div>
              <h3 style={{ marginTop: 0, fontSize: '1.2rem' }}>🏗️ AI Proposal & RFP Writer</h3>
              <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}>Draft custom agency proposals matched against past winning work.</p>
              <div style={{ marginBottom: '16px' }}>
                <label style={{ display: 'block', fontSize: '0.85rem', color: '#94a3b8', marginBottom: '6px' }}>RFP Requirements</label>
                <textarea rows={4} value={rfpReq} onChange={(e) => setRfpReq(e.target.value)} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.1)', backgroundColor: 'var(--bg-base)', color: 'white' }} />
              </div>
              <div style={{ marginBottom: '20px' }}>
                <label style={{ display: 'block', fontSize: '0.85rem', color: '#94a3b8', marginBottom: '6px' }}>Agency Past Winning Projects</label>
                <textarea rows={4} value={agencyPast} onChange={(e) => setAgencyPast(e.target.value)} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.1)', backgroundColor: 'var(--bg-base)', color: 'white' }} />
              </div>
          ...
          {activeTab === 'medical' && (
            <div>
              <h3 style={{ marginTop: 0, fontSize: '1.2rem' }}>🧑‍⚕️ Medical Pre-Consultation Assistant</h3>
              <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}>Synthesize patient symptom intake into concise doctor briefing notes.</p>
              <div style={{ marginBottom: '16px' }}>
                <label style={{ display: 'block', fontSize: '0.85rem', color: '#94a3b8', marginBottom: '6px' }}>Patient Symptoms</label>
                <textarea rows={4} value={patientSymptoms} onChange={(e) => setPatientSymptoms(e.target.value)} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.1)', backgroundColor: 'var(--bg-base)', color: 'white' }} />
              </div>
              <div style={{ marginBottom: '20px' }}>
                <label style={{ display: 'block', fontSize: '0.85rem', color: '#94a3b8', marginBottom: '6px' }}>Medical History</label>
                <textarea rows={4} value={medicalHistory} onChange={(e) => setMedicalHistory(e.target.value)} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.1)', backgroundColor: 'var(--bg-base)', color: 'white' }} />
              </div>
          ...
          {activeTab === 'sales' && (
            <div>
              <h3 style={{ marginTop: 0, fontSize: '1.2rem' }}>🛒 B2B Sales Intelligence Battlecard</h3>
              <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}>Generate 1-page B2B sales battlecards for outbound SDR teams.</p>
              <div style={{ marginBottom: '16px' }}>
                <label style={{ display: 'block', fontSize: '0.85rem', color: '#94a3b8', marginBottom: '6px' }}>Prospect Company Name</label>
                <input value={companyName} onChange={(e) => setCompanyName(e.target.value)} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.1)', backgroundColor: 'var(--bg-base)', color: 'white' }} />
              </div>
              <div style={{ marginBottom: '20px' }}>
                <label style={{ display: 'block', fontSize: '0.85rem', color: '#94a3b8', marginBottom: '6px' }}>Industry</label>
                <input value={industry} onChange={(e) => setIndustry(e.target.value)} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.1)', backgroundColor: 'var(--bg-base)', color: 'white' }} />
              </div>
        ...
        <div style={{ backgroundColor: 'var(--bg-card)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.08)', padding: '24px', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ flex: 1, backgroundColor: 'var(--bg-base)', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.05)', padding: '16px', fontFamily: 'monospace', overflowY: 'auto', maxHeight: '500px' }}>
            {loading ? (
              ...
              <pre style={{ margin: 0, whiteSpace: 'pre-wrap', color: '#38bdf8', fontSize: '0.85rem' }}>
